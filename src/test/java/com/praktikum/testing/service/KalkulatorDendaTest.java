...
public class KalkulatorDendaTest {
    ...
    void testTidakAdaDendaUntukPeminjamanTidakTerlambat() {
        LocalDate tanggalPinjam = LocalDate.now().minusDays(0);
    ...
    void testHitungDendaMahasiswaTigaHariTerlambat() {
        ...
        Peminjaman peminjaman = new Peminjaman("P002", "M001", "9876543210",
                tanggalPinjam, tanggalJatuhTempo);

        double dendaAktual = kalkulatorDenda.hitungDenda(peminjaman, anggotaMahasiswa);

        assertEquals(3000.0, dendaAktual, "Denda mahasiswa 3 hari terlambat harus sesuai aturan");
    }
    ...
    void testGetTarifDendaHarian() {
        assertEquals(2000.0, kalkulatorDenda.getTarifDendaHarian(Anggota.TipeAnggota.MAHASISWA));
        assertEquals(1000.0, kalkulatorDenda.getTarifDendaHarian(Anggota.TipeAnggota.DOSEN));
        assertEquals(500.0, kalkulatorDenda.getTarifDendaHarian(Anggota.TipeAnggota.UMUM));
    ...
    void testGetDendaMaksimal() {
        ...
        assertEquals(5000.0, kalkulatorDenda.getDendaMaximal(Anggota.TipeAnggota.UMUM));
